...
extension NSAttributeDescription {
    ...
    public static func dataType(name: String, defaultValue: NSData? = nil, indexed: Bool? = nil, optional: Bool? = nil) -> NSAttributeDescription {
    ...
    public static func transformableType<A: NSObject>(name: String, transform: DataTransform<A?>, indexed: Bool? = nil, optional: Bool? = nil) -> NSAttributeDescription {
        ...
        ValueTransformer.registerTransformerWithName(transform.name, transform: transform.forward, reverseTransform: transform.reverse)
        attr.valueTransformerName = transform.name
