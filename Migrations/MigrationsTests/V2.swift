...
private struct MoodV2: TestEntityDataType {
    let entityName = "Mood"
    ...
    init(markedForRemoteDeletion: Bool, country: CountryV2?, date: NSDate, latitude: Double, longitude: Double, markedForDeletionDate: NSDate?, creatorID: String?, remoteID: String?, colors: NSData, rating: Int) {
...
private struct CountryV2: TestEntityDataType {
    ...
    init(numberOfMoods: Int, numericISO3166Code: Int, continent: ContinentV2?, markedForDeletionDate: NSDate?, updatedAt: NSDate) {
...
private struct ContinentV2: TestEntityDataType {
...
let v2Data: TestVersionData = {
    var continent1 = ContinentV2(numberOfMoods: 8, numberOfCountries: 6, numericISO3166Code: 10005, markedForDeletionDate: nil, updatedAt: NSDate(timeIntervalSinceReferenceDate: 465131737.392830))
    var continent2 = ContinentV2(numberOfMoods: 8, numberOfCountries: 4, numericISO3166Code: 10004, markedForDeletionDate: nil, updatedAt: NSDate(timeIntervalSinceReferenceDate: 464687061.663903))

    var country21 = CountryV2(numberOfMoods: 2, numericISO3166Code: 710, continent: continent2, markedForDeletionDate: nil, updatedAt: NSDate(timeIntervalSinceReferenceDate: 464687061.782827))
    var country30 = CountryV2(numberOfMoods: 1, numericISO3166Code: 704, continent: continent1, markedForDeletionDate: nil, updatedAt: NSDate(timeIntervalSinceReferenceDate: 464687061.722586))
    var country31 = CountryV2(numberOfMoods: 1, numericISO3166Code: 231, continent: continent2, markedForDeletionDate: nil, updatedAt: NSDate(timeIntervalSinceReferenceDate: 464687061.668211))

    let mood1 = MoodV2(markedForRemoteDeletion: false, country: country30, date: NSDate(timeIntervalSinceReferenceDate: 464441952.529884), latitude: 13.154376, longitude: 108.193359, markedForDeletionDate: nil, creatorID: "__defaultOwner__", remoteID: "64C6E1D4-7C2E-4F04-B867-1A9E2941F9FF", colors: NSData(base64EncodedString: "a2Va3d/kSEIxJyQLiIeGCwkDOSwLmJmd", options: NSDataBase64DecodingOptions())!, rating: 0)
    let mood2 = MoodV2(markedForRemoteDeletion: false, country: country21, date: NSDate(timeIntervalSinceReferenceDate: 464369360.734390), latitude: -26.000000, longitude: 28.000000, markedForDeletionDate: nil, creatorID: "__defaultOwner__", remoteID: "47300BAD-DE7D-4B54-B94C-04A3EE4CD0C5", colors: NSData(base64EncodedString: "a2Va3d/kSEIxJyQLiIeGCwkDOSwLmJmd", options: NSDataBase64DecodingOptions())!, rating: 0)
    let mood3 = MoodV2(markedForRemoteDeletion: false, country: country31, date: NSDate(timeIntervalSinceReferenceDate: 464442000.641578), latitude: 7.013668, longitude: 41.308594, markedForDeletionDate: nil, creatorID: "__defaultOwner__", remoteID: "83922344-ED0B-4ABE-B8B0-E00F4E7E1D94", colors: NSData(base64EncodedString: "8fP4YVtDZWU3usfgRT8gTE8cTTktfHlf", options: NSDataBase64DecodingOptions())!, rating: 0)
    let mood4 = MoodV2(markedForRemoteDeletion: false, country: country21, date: NSDate(timeIntervalSinceReferenceDate: 464369352.554507), latitude: -26.000000, longitude: 28.000000, markedForDeletionDate: nil, creatorID: "__defaultOwner__", remoteID: "3A9BAEFD-7716-41C0-9FFF-A7C4BCE32679", colors: NSData(base64EncodedString: "XkUa493ZlI1/epW2MSIOFQ8HQSoOTUAs", options: NSDataBase64DecodingOptions())!, rating: 0)
